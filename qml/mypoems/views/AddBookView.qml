...
DrawerFrame {
    ...
    headerLabel.text: renameMode? qsTr("Rename Book") : qsTr("Add Book") + Translations.refresher
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Label {
                ...
                text: qsTr("Please enter book name:") + Translations.refresher
            }
        }
        ...
        TextField {
            ...
            placeholderText: qsTr("Book Name") + Translations.refresher
            font.pixelSize: 9 * Devices.fontDensity
