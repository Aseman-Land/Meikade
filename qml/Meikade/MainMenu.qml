...
Item {
    ...
    AsemanListView {
        ...
        function refresh() {
            ...
            model.append({"name":qsTr("Bookmarks")         , "icon": Awesome.fa_bookmark, "fileName":"BookmarksPoets.qml"         , "type": "A"})
...
//            model.append({"name":qsTr("Notes")             , "icon": Awesome.fa_sticky_note, "fileName":"Notes.qml"             , "type": "A"})
            model.append({"name":qsTr("Configure")         , "icon": Awesome.fa_cogs, "fileName":"Configure.qml"         , "type": "C"})
            model.append({"name":qsTr("OpenSource Projecs"), "icon": Awesome.fa_free_code_camp, "fileName":"OpenSourceProjects.qml", "type": "C"})
            model.append({"name":qsTr("Contact")           , "icon": Awesome.fa_phone, "fileName":"Contact.qml"            , "type": "C"})
