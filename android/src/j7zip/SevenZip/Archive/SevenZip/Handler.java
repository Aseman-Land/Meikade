...
public class Handler implements SevenZip.Archive.IInArchive {
    ...
    public int Extract(int[] indices, int numItems,
            int testModeSpec, IArchiveExtractCallback extractCallbackSpec, String parent_dir) throws IOException {
        ...
        for (int i = 0; i < extractFolderInfoVector.size(); i++, currentImportantTotalUnPacked += totalFolderUnPacked) {
            ...
            FolderOutStream folderOutStream = new FolderOutStream(parent_dir);
